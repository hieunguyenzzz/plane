...
export default {
  ...
  // Mobelaris fork — view folders (sidebar grouping)
  view_folders_create: "Create folder",
  view_folders_rename: "Rename folder",
  view_folders_delete: "Delete folder",
  view_folders_delete_confirm: "Delete this folder? The views inside will move back to the top level.",
  view_folders_empty: "No views in this folder",
  view_folders_no_views: "No views yet",
  view_folders_unfiled: "Ungrouped",
  view_folders_move_to: "Move to folder",
  view_folders_move_to_root: "Remove from folder",
  view_folder_name_placeholder: "Folder name",
  view_folder_created_successfully: "Folder created",
  view_folder_renamed_successfully: "Folder renamed",
  view_folder_deleted_successfully: "Folder deleted",
  failed_to_create_view_folder: "Couldn't create the folder. Please try again.",
  failed_to_rename_view_folder: "Couldn't rename the folder. Please try again.",
  failed_to_delete_view_folder: "Couldn't delete the folder. Please try again.",
  failed_to_move_view_to_folder: "Couldn't move the view. Please try again.",
