...
// Mobelaris fork — Tier B: allow `cp_<uuid>` filter keys for custom properties.
export type TWorkItemFilterProperty = (typeof WORK_ITEM_FILTER_PROPERTY_KEYS)[number] | `cp_${string}`;
